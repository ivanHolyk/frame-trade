                ...
                <div class="modal-body">
                    ...
                    <div class="input-group mb-2">
                        <input type="number" id="order-price" class="form-control" placeholder="Price" min="1"
                            ...
                            :disabled="!order"> <span v-if="isPriceAwait" class="spinner-border spinner-border-sm"
                    ...
                    <select class="form-select" v-if="isMod" v-model="modRank">
                        ...
                        <option value="0" :selected="rank === modRank">
                            0
                        </option>
                    ...
                    <select class="form-select" v-if="isArcane" v-model="arcaneRank">
                        ...
                        <option value="0" :selected="rank === arcaneRank">
                            0
                        </option>
